...
- 🎓 Final-year ECE student at **LNMIIT Jaipur**
- 📍 Based in **Jaipur, India**
- 🛠️ I like building systems that feel production-ready, not project-ready
- ⚡ Strongest zones: **FastAPI, SQL, PostgreSQL, Docker, Redis, RAG**
- 🎯 Focused on **backend engineering, scalable APIs, AI products, and system design**
...
- ⚔️ **LeetCode Knight**
- 🧠 **300+ problems solved**
- 🚀 Building products across **backend, ML, and AI**
...
- 🤖 **RAG assistants** with better accuracy and lower memory use
...
- RBAC, billing flows, auth, email verification
